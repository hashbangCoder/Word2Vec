...
parser.add_option("-o", "--output", dest="outputFile",help="Weights output file name",default = '../OutputInfo/GRU_BiDi')           # Output file name for losses, accuracy info
...
if not options.model_weights:
	...
	model.save_weights('../OutputInfo/ModelParams/LSTM_params_BiDi_%s.h5'%curr_time)
	print 'Model parameters stored at ../OutputInfo/ModelParams/LSTM_BiDi_%s.h5' %curr_time
