...
parser.add_option("-o", "--output", dest="output",
				  help="Weights output file name",default = 'word2vec_train_results.pkl')
parser.add_option("-p", "--pretrained", dest="pretrained",
				  help="Pretrained word vector file name",default = 'Pretrained_WordVecs')

parser.add_option("-d", "--dir", dest="dir",help="Directory to read from",default = None)
parser.add_option("--exist", dest="exist",help="Path to tokenized and pickled word list",default = False)
...
parser.add_option("-f","--frequency-threshold",dest = 'freq', help = "Minimum threshold for considering words", default = 3)
